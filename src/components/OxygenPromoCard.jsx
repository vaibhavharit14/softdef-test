    ...
    <section className="relative bg-[#1b2316] text-white py-16">
      <div className="relative max-w-[1728px] mx-auto">
        ...
        >
          ...
          <div className="absolute top-[135px] right-[4px] text-white text-center md:text-left md:w-1/2  px-8">
            <h3 className="font-['Inter'] font-semibold text-[38px] leading-[100%] tracking-[0] mb-[42px]">
              We Have Small And Best O₂ Plants Collection’s
            </h3>

            <div className="space-y-4 mb-4">
              <p className="font-['Inter'] font-semibold text-[28px] leading-[100%] tracking-[0] text-gray-300 mb-[42px]">
                Oxygen-producing plants, often referred to as “O₂ plants,” are
                those that release oxygen into the atmosphere through the
                process of photosynthesis.
              </p>
              <p className="font-['Inter'] font-semibold text-[28px] leading-[100%] tracking-[0] text-gray-300">
        ...
        <div className="flex justify-center mt-[133px]">
